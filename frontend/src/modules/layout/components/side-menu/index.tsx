            ...
            <>
              <div className="relative flex h-full">
                <Popover.Button
                  ...
                  className="w-10 h-10 -ml-2 flex items-center justify-center rounded-full text-header-fg hover:bg-header-hover hover:text-header-accent focus:outline-none transition-colors"
                >
                  <i className="ph-bold ph-list text-[22px]" aria-hidden />
                </Popover.Button>
              </div>
