...
const CartTemplate = ({
  ...
  return (
    <>
      {/* Mobile app bar — replaces the storefront header on this screen
          (see `app-bar-route` in globals.css). No cart button: we're on
          the cart already. */}
      <AppBar title="My Cart" showCart={false} />
