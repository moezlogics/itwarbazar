...
export function Pagination({
  ...
  totalPages: number
  /**
   * When provided, the parent owns paging (client-side, instant — no
   * server round-trip). Falls back to a router navigation otherwise so
   * the component stays usable anywhere.
   */
