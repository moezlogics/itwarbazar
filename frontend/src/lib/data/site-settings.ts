...
export type SiteSettings = {
  ...
  //   "fashion"  → ClothingStore schema, fashion-flavoured chatbot
  //   "grocery"  → GroceryStore schema, grocery-flavoured chatbot
  //   "pharmacy" → Pharmacy schema (medicalSpecialty)
  //   "electronics" → ElectronicsStore schema
  //   "general"  → generic Store schema
  // Default = "fashion". Back-compat: a non-empty `pharmacy_license_number`
