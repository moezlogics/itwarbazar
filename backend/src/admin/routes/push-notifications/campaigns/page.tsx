...
const DEFAULT_ACTION_URL = "https://itwarbazar.pk/"
          ...
          <div style={adminSection}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 14 }}>
              ...
              <Field label="Action URL">
                <Input
                  placeholder="https://itwarbazar.pk/collections/new-arrivals"
                  value={form.action_url}
                  onChange={(e) => setForm({ ...form, action_url: e.target.value })}
                />
                <p style={adminHelpText}>
                  Where the user goes when the notification is clicked. Enter a complete URL (e.g. internal pages like https://itwarbazar.pk/collections/new-arrivals or external sites like https://google.com).
                </p>
              </Field>
