cat > /home/itwarbazar-api/htdocs/api.itwarbazar.pk/ecosystem.config.js << 'SCRIPT'
/**
...
module.exports = {
  apps: [
    {
      name: "medusa-backend",
      cwd: "/home/itwarbazar-api/htdocs/api.itwarbazar.pk",
      ...
      error_file: "/home/itwarbazar-api/htdocs/api.itwarbazar.pk/logs/medusa-error.log",
      out_file: "/home/itwarbazar-api/htdocs/api.itwarbazar.pk/logs/medusa-out.log",
      merge_logs: true,
      time: true
    }
  ]
...
mkdir -p /home/itwarbazar-api/htdocs/api.itwarbazar.pk/logs
